...
# Cargar los modelos desde el mismo directorio que app.py
vectorizador_path = os.path.join(current_dir, "vectorizador_tfidf.joblib")
modelo_sentimiento_path = os.path.join(current_dir, "modelo_sentimiento.joblib")
...
def predecir_sentimiento(texto):
    ...
    pred = modelo_sentimiento.predict(X_vector)[0]
    return pred
